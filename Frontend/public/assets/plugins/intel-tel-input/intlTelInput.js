...
(function(factory) {
    ...
    return function() {
        ...
        var defaults = {
            ...
            // specify the path to the libphonenumber Scripts to enable validation/formatting
            utilsScript: ""
        };
        ...
        function() {
            ...
            _createClass(Iti, [ {
                ...
                value: function _init() {
                    ...
                    this._initListeners();
                    // utils Scripts, and auto country
                    this._initRequests();
                }
            }, {
                ...
                value: function _initRequests() {
                    var _this5 = this;
                    // if the user has specified the path to the utils Scripts, fetch it on window.load, else resolve
 ...
 ********************/
        ...
        // inject a <Scripts> element to load utils.js
        var injectScript = function injectScript(path, handleSuccess, handleFailure) {
            // inject a new Scripts element into the page
