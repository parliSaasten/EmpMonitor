...
gj.dialog.config = {
    base: {
        ...
        /** Specifies whether the dialog should have a close button in right part of dialog Headers.
         * @type boolean
         * @default true
         * @example True <!-- dialog.base, draggable -->
         * <div id="dialog">
         *     <div data-role="Headers"><h4 data-role="title">Dialog</h4></div>
         ...
         * <Scripts src="../../dist/modular/dialog/js/messages/messages.fr-fr.js"></Scripts>
         * <div id="dialog">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</div>
         * <Scripts>
         *     $("#dialog").dialog({
         *         resizable: true,
        ...
        style: {
            ...
            header: 'gj-dialog-md-Headers gj-unselectable',
...
gj.dialog.methods = {
    ...
    renderHeader: function ($dialog) {
        ...
        $header = $dialog.children('div[data-role="Headers"]');
        if ($header.length === 0) {
            $header = $('<div data-role="Headers" />');
    ...
    destroy: function ($dialog, keepHtml) {
        ...
        if (data) {
            if (keepHtml === false) {
                ...
                $dialog.find('[data-role="Headers"]').removeClass(data.style.header);
...
gj.grid.config = {
    base: {
         ...
         * If set to object, then the grid is going to use this object as Setting for the <a href="http://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
        ...
        /** An object that holds the default configuration Setting of each column from the grid.
         * @type object
         * @example sample <!-- grid -->
         * <table id="grid"></table>
         * <Scripts>
        ...
        defaultColumnSettings: {
             ...
             * If set to true the user can click the column Headers and sort the grid by the column source field.
            ...
            /** The caption that is going to be displayed in the Headers of the grid.
             * @alias column.title
             * @type string
             * @default undefined
             * @example sample <!-- grid -->
            ...
            /** The name(s) of css class(es) that are going to be applied to all cells inside that column, except the Headers cell.
            ...
            /** The name(s) of css class(es) that are going to be applied to the Headers cell of that column.
         ...
         * <table id="grid"></table>
         * <Scripts src="../../dist/modular/grid/js/messages/messages.de-de.js"></Scripts>
         * <Scripts>
         *     $('#grid').grid({
         *         dataSource: { url: '/Players/Get', data: { name: 'not existing name' } },
         *         locale: 'de-de',
        ...
        /** This configuration option manage the behaviour of the Headers row height.
...
gj.grid.methods = {
    ...
    initialize: function ($grid) {
        ...
        if (data.headerRowHeight === 'autogrow') {
            $grid.addClass('autogrow-Headers-row');
        }
...
gj.grid.plugins.inlineEditing.config = {
    base: {
        defaultColumnSettings: {
             ...
             * <Scripts src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></Scripts>
             * <table id="grid"></table>
             * <Scripts>
...
gj.grid.plugins.responsiveDesign = {
    config: {
        base: {
             ...
             * The visibility of the columns in this mode is driven by the column minWidth and priority Setting.
...
gj.grid.plugins.resizableColumns = {
    config: {
        base: {
            /** If set to true, users can resize columns by dragging the edges (resize handles) of their Headers cells.
             * @type boolean
             * @default false
...
gj.grid.plugins.headerFilter = {
    config: {
        base: {
            defaultColumnSettings: {
                /** Indicates if the column is sortable. If set to false the Headers filter is hidden.
...
gj.tree.config = {
    base: {
         ...
         * If set to object, then the tree is going to use this object as Setting for the <a href="http://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
...
gj.editor.config = {
    base: {
         ...
         * <Scripts src="../../dist/modular/editor/js/messages/messages.fr-fr.js"></Scripts>
         ...
         * <Scripts src="../../dist/modular/editor/js/messages/messages.de-de.js"></Scripts>
...
gj.dropdown.config = {
    base: {
         ...
         * If set to object, then the dropdown is going to use this object as Setting for the <a href="http://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
...
gj.datepicker.config = {
    base: {
         ...
         * <input id="datepicker" width="312" />
         * <Scripts>
         *    $('#datepicker').datepicker({ keyboardNavigation: true, modal: true, Headers: true, footer: true });
         * </Scripts>
         * @example Bootstrap.4 <!-- bootstrap4, datepicker -->
         * <input id="datepicker" width="234" />
         * <Scripts>
         ...
         * <input id="datepicker" width="220" />
         * <Scripts>
         *    $('#datepicker').datepicker({ uiLibrary: 'bootstrap', modal: true, Headers: true, footer: true });
         * </Scripts>
         * @example Bootstrap.4 <!-- bootstrap4, datepicker -->
         * <input id="datepicker" width="234" />
         * <Scripts>
         *    $('#datepicker').datepicker({ uiLibrary: 'bootstrap4', modal: true, Headers: true, footer: true });
         * </Scripts>
         */
        modal: false,

        /** If set to true, add Headers to the datepicker.
         * @type Boolean
         * @default false
         * @example True <!-- datepicker -->
         * <input id="datepicker" width="312" />
         * <Scripts>
         *    $('#datepicker').datepicker({ Headers: true, modal: true, footer: true });
         * </Scripts>
         * @example False <!-- datepicker -->
         * <input id="datepicker" width="312" />
         * <Scripts>
         *    $('#datepicker').datepicker({ Headers: false });
         * </Scripts>
         */
        header: false,
         ...
         * <input id="datepicker" width="312" />
         * <Scripts>
         *    $('#datepicker').datepicker({ footer: true, modal: true, Headers: true });
         * </Scripts>
         * @example False <!-- datepicker -->
         * <input id="datepicker" width="312" />
         * <Scripts>
...
gj.datepicker.methods = {
    ...
    updateHeader: function ($calendar, data, date) {
        $calendar.find('[role="Headers"] [role="year"]').removeClass('selected').html(gj.core.formatDate(date, 'yyyy', data.locale));
        $calendar.find('[role="Headers"] [role="date"]').addClass('selected').html(gj.core.formatDate(date, 'ddd, mmm dd', data.locale));
        $calendar.find('[role="Headers"] [role="hour"]').removeClass('selected').html(gj.core.formatDate(date, 'HH', data.locale));
        $calendar.find('[role="Headers"] [role="minute"]').removeClass('selected').html(gj.core.formatDate(date, 'MM', data.locale));
    },
...
gj.timepicker.config = {
    base: {
         ...
         * <input id="timepicker" width="280" />
         * <Scripts>
         *    $('#timepicker').timepicker({ modal: false, Headers: false, footer: false });
         * </Scripts>
         */
        modal: true,

        /** If set to true, add Headers to the timepicker.
         * @type Boolean
         * @default true
         * @example True <!-- timepicker -->
         * <input id="timepicker" width="280" />
         * <Scripts>
         *    $('#timepicker').timepicker({ Headers: true });
         * </Scripts>
         * @example False <!-- timepicker -->
         * <input id="timepicker" width="280" />
         * <Scripts>
         *    $('#timepicker').timepicker({ Headers: false, mode: '24hr' });
         * </Scripts>
         */
        header: true,
...
gj.timepicker.methods = {
    ...
    update: function ($timepicker, $clock, data) {
        ...
        // update the Headers
        if (data.header) {
            $header = $clock.find('[role="Headers"]');
    ...
    renderHours: function ($timepicker, $clock, data) {
        ...
        $clock.find('[role="Headers"] [role="hour"]').addClass('selected');
        $clock.find('[role="Headers"] [role="minute"]').removeClass('selected');
    ...
    renderMinutes: function ($timepicker, $clock, data) {
        ...
        $clock.find('[role="Headers"] [role="hour"]').removeClass('selected');
        $clock.find('[role="Headers"] [role="minute"]').addClass('selected');
...
gj.timepicker.widget = function ($element, jsConfig) {
     ...
     * <input id="timepicker" width="312" />
     * <Scripts>
     *     var $timepicker = $('#timepicker').timepicker({ modal: false, Headers: false, footer: false, mode: '24hr' });
     * </Scripts>
     */
    self.open = function () {
...
gj.datetimepicker.config = {
    base: {
         ...
         * <input id="input" width="312" />
         * <Scripts>
         *    $('#input').datetimepicker({ footer: true, modal: true, Headers: true });
         * </Scripts>
...
gj.datetimepicker.methods = {
    ...
    initialize: function ($datetimepicker) {
        ...
        $datetimepicker.on('open', function () {
            var $header = $picker.children('[role="Headers"]');
