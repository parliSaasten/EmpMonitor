	...
	obj.html(
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-Headers plupload_header">' +
				...
				'<table class="plupload_filelist plupload_filelist_header ui-widget-Headers">' +
				'<tr>' +
				...
				'<table class="plupload_filelist plupload_filelist_footer ui-widget-Headers">' +
				'<tr>' +
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_delete" id="{id}" style="width:{thumb_width}px;">' +
			...
			'<div class="plupload_file_status">' +
				'<div class="plupload_file_progress ui-widget-Headers" style="width: 0%"> </div>' +
