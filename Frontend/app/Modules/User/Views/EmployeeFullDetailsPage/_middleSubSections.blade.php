        ...
        <div class="card">
            <div class="card-body">
                <div class="btn-group nav nav-tabs tab-action-wrapper">
                    <a type="button" class="btn btn-info nav-link" data-toggle="tab" href="#Timesheets" id="TimesheetsTab"
                        onclick="loadTimeSheetData()" title="{{ __('messages.timesheets') }}"><i
                            class="far fa-calendar-alt mr-2"></i>{{ __('messages.timesheets') }}</a>

                    <a type="button" class="btn btn-info nav-link" data-toggle="tab" onclick="loadBrowserHistory()"
                        href="#BrowserHistory" id="BrowserHistoryTab" title="{{ __('messages.webHistory') }}"><i
                    ...
                    <a type="button" class="btn btn-info nav-link" data-toggle="tab" onclick="loadWebAppHistory(1)"
                        href="#AppHistory" id="AppHistoryTab" title=" {{ __('messages.applicationHistory') }} "><i
                            ...
                            <table id="timeSheetDataTable" class="table table-striped table-bordered ad_tab w-100">
                                <thead>
                                    <tr class="table-primary"> 
                                        ...
                                        <th>{{ __('messages.totalHours') }}<i class="fas fa-info-circle ml-1"
